  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item prop="materialName">
        <label for="query-material-name">材质名称</label>
        <el-input
          id="query-material-name"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['tile:material:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :icon="Download"
          @click="handleExport"
          v-hasPermi="['tile:material:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="materialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="材质编号" align="center" prop="materialId" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item prop="materialName">
          <label for="form-material-name">材质名称</label>
          <el-input
...
import { listMaterial, getMaterial, delMaterial, addMaterial, updateMaterial } from "@/api/tile/material"
...
const rules = ref({
  materialName: [
    ...
    { min: 0, max: 30, message: '材质名称长度不能超过30个字符', trigger: 'blur' }
  ],
  orderNum: [
...
function handleDelete(row) {
  ...
  ElMessageBox.confirm('是否确认删除材质编号为"' + materialIds + '"的数据项?', "警告", {
    confirmButtonText: "确定",
    cancelButtonText: "取消",
    type: "warning"
  }).then(function() {
...
function handleExport() {
  ElMessageBox.confirm('是否确认导出所有材质数据项?', "警告", {
    confirmButtonText: "确定",
    cancelButtonText: "取消",
    type: "warning"
  }).then(function() {
    return exportMaterial(queryParams.value)
  }).then(response => {
...
function handleStatusChange(row) {
  ...
  ElMessageBox.confirm('确认要"' + text + '""' + row.materialName + '"吗?', "警告", {
    confirmButtonText: "确定",
    cancelButtonText: "取消",
    type: "warning"
  }).then(function() {
